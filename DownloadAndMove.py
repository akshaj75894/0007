...
from_dir = "C:/Users/RDxMANDRIN/Downloads"              # Add the path of you "Downloads" folder.
to_dir = "test" #Create "Document_Files" folder in your Desktop and update the path accordingly.
